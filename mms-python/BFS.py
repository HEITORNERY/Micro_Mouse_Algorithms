...
def mark_visited_api(pos=None):
    ...
    API.setText(pos[0], pos[1], "Ja vi")  # drop string containing info on square
...
def mark_solution_api(pos=None):
    ...
    API.setText(pos[0], pos[1], "Continue")
...
def mark_bktrk_api(pos=None):
    ...
    API.setText(pos[0], pos[1], "Objetivo")
...
def execute_shortest_path(sol):
    ...
    log("Tempo para executar o caminho mais curto: {:.2f} segundos".format(end_time - start_time))
